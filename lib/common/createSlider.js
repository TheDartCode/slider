    ...
    (0, _createClass3['default'])(ComponentEnhancer, [{
      ...
      value: function calcValue(offset) {
        ...
        if (canonical) {
          ...
          var floatIndex = ratio * (marksKeys.length - 1);

          var borderValues = [marksKeys[Math.floor(floatIndex)], marksKeys[Math.ceil(floatIndex)]];
